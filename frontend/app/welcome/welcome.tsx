...
export function Welcome() {
	const [items, setItems] = useState<{ id: string; content: string }[]>([
		...
		{ id: "3", content: "Edit list" },
		{ id: "4", content: "Delete list" },
		{ id: "5", content: "Add item" },
		{ id: "6", content: "Delete item" },
	]);
							...
							<Grid items={items} onSortEnd={setItems} sortable>
								{items.map((item) => (
									<GridItem key={item.id} id={item.id}>
										<div className="card bg-neutral text-neutral-content cursor-grab active:cursor-grabbing">
